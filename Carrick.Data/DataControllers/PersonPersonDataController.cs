...
namespace Carrick.Data.Controllers
{
    ...
    using System.Linq;
    public class PersonPersonDataController : GenericDataController<PersonPerson>
    {

        internal PersonPersonDataController(Repository r) : base(r, r.DataModel.PersonPersons)
        {
        }
