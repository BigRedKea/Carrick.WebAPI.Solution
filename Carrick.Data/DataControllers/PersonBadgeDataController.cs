namespace Carrick.Data.Controllers
{
    ...
    public class PersonBadgeDataController : GenericDataController<PersonBadge>
    {

        internal PersonBadgeDataController(Repository r) : base(r, r.DataModel.PersonBadges)
        {
        }
